...
class ASCIIMathTeXImgUnitTest {
	...
	@CsvSource({
		...
		" '(:2,3:)'                                                , '{\\left\\langle{2},{3}\\right\\rangle}' ",
		" '[(2,3),(4,5)]'                                          , '{\\left[\\begin{matrix}{2}&{3}\\\\{4}&{5}\\end{matrix}\\right]}' ",
		" '[(2,3,4,5)]'                                            , '{\\left[\\begin{matrix}{2}&{3}&{4}&{5}\\end{matrix}\\right]}' ",
		" '((1),(2))'                                              , '{\\left(\\begin{matrix}{1}\\\\{2}\\end{matrix}\\right)}' ",
		" '{(1,if,x ge 3),(2,if,x gt 3):}'                         , '{\\left\\lbrace\\begin{matrix}{1}&{\\quad\\text{if}\\quad}&{x}\\ge{3}\\\\{2}&{\\quad\\text{if}\\quad}&{x}\\gt{3}\\end{matrix}\\right.}' ",
		" '[(1,2,|,3),(4,5,|,6)]'                                  , '{\\left[\\begin{matrix}{1}&{2}&{\\mid}&{3}\\\\{4}&{5}&{\\mid}&{6}\\end{matrix}\\right]}' ",
		...
		" '2,3)'                                                   , '{2},{3}{)}' ",
		" '(2,3'                                                   , '{\\left({2},{3}\\right.}' ",
		" '[(1,2,3,|,4),(5,6,7, |,8)]'                             , '{\\left[\\begin{matrix}{1}&{2}&{3}&{\\mid}&{4}\\\\{5}&{6}&{7}&{\\mid}&{8}\\end{matrix}\\right]}' ",
		" '[(1,2,3, | ,4,5),(5,6,7, | ,8,9)]'                      , '{\\left[\\begin{matrix}{1}&{2}&{3}&{\\mid}&{4}&{5}\\\\{5}&{6}&{7}&{\\mid}&{8}&{9}\\end{matrix}\\right]}' ",
		" '[(1,|,2,3,4),(5,|,6,7,8)]'                              , '{\\left[\\begin{matrix}{1}&{\\mid}&{2}&{3}&{4}\\\\{5}&{\\mid}&{6}&{7}&{8}\\end{matrix}\\right]}' ",
		" '[(1,|,3,|,4),(5,|,7,|,8)]'                              , '{\\left[\\begin{matrix}{1}&{\\left|,{3},\\right|}&{4}\\\\{5}&{\\left|,{7},\\right|}&{8}\\end{matrix}\\right]}' ",
		" '[(2,|x|,5),(3,|y|,4)]'                                  , '{\\left[\\begin{matrix}{2}&{\\left|{x}\\right|}&{5}\\\\{3}&{\\left|{y}\\right|}&{4}\\end{matrix}\\right]}' ",
		" '[(1,|,2,|x|,5),(3,|,4,|y|,7)]'                          , '{\\left[\\begin{matrix}{1}&{\\left|,{2},\\right|}{x}{\\mid}&{5}\\\\{3}&{\\left|,{4},\\right|}{y}{\\mid}&{7}\\end{matrix}\\right]}' ",
		" '[(1,2,3,|,4),(5,6,7,8,9)]'                              , '{\\left[\\begin{matrix}{1}&{2}&{3}&{\\mid}&{4}\\\\{5}&{6}&{7}&{8}&{9}\\end{matrix}\\right]}' ",
		" '[(1,2,3,|,4),(5,6,7,8)]'                                , '{\\left[{\\left({1},{2},{3},{\\mid},{4}\\right)},{\\left({5},{6},{7},{8}\\right)}\\right]}' ",
		" '[(1,2,3,4,5),(5,6,7,|,9)]'                              , '{\\left[\\begin{matrix}{1}&{2}&{3}&{4}&{5}\\\\{5}&{6}&{7}&{\\mid}&{9}\\end{matrix}\\right]}' ",
		" '[(1,2,3,4),(5,6,7,|,9)]'                                , '{\\left[{\\left({1},{2},{3},{4}\\right)},{\\left({5},{6},{7},{\\mid},{9}\\right)}\\right]}' ",
		" '[(1,2,3,|),(5,6,7,|)]'                                  , '{\\left[\\begin{matrix}{1}&{2}&{3}&{\\mid}\\\\{5}&{6}&{7}&{\\mid}\\end{matrix}\\right]}' ",
		...
		" '1/fx^2'                                                 , '\\frac{{1}}{{f}}{x}^{{2}}' ",
		" 'f'(x)/5'                                                , '{f}'\\frac{{{x}}}{{5}}' ",
		" '[[1,2]]/4'                                              , '\\frac{{\\begin{matrix}{1}&{2}\\end{matrix}}}{{4}}' ",
		" '(x+2)/3'                                                , '\\frac{{{x}+{2}}}{{3}}' ",
